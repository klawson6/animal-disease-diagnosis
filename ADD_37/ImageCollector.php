...
if (!((isset($data->identifier)||isset($data->name)) && isset($data->dateSelected) && isset($data->location) && isset($data->species) && isset($data->age) && isset($data->sex) && isset($data->breed) && isset($data->diagnosis) && isset($data->type) && isset($data->sides))) {
    $response->data = $data;
    echo json_encode($response);
    exit(0);
}
