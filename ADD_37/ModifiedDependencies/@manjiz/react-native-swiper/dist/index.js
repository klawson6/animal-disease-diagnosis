...
export default class default_1 extends Component {
    constructor() {
        ...
        this.renderPagination = () => {
            if (this.state.total <= 1)
                return null;
            const dots = [];
            const ActiveDot = this.props.activeDot || (React.createElement(View, {
                style: [{
            ...
            const Dot = this.props.dot || (React.createElement(View, {
                style: [{
            ...
            return (React.createElement(View, {
                pointerEvents: 'none',
                style: [styles[this.state.dir === 'x' ? `pagination_x` : `pagination_y`], this.props.paginationStyle]
            }, dots));
        };
        this.renderScrollView = (pages) => {
            return (React.createElement(ScrollView, Object.assign({}, this.props, this.scrollViewPropOverrides(), {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.offset !== this.state.offset && prevState.offset[dir] !== this.state.offset[dir]) {
            ...
            node && node.scrollTo(Object.assign({}, this.state.offset, {
                ...
                if (loadMinimal) {
                    if (i >= (index + loopVal - loadMinimalSize) &&
                        ...
                        return (React.createElement(View, {
                            ...
                            key: i
                        }, loadMinimalLoader ? loadMinimalLoader : React.createElement(ActivityIndicator, null)));
                    }
                } else {
                    return React.createElement(View, {style: pageStyle, key: i}, children[parseInt(pageIdx)]);
                }
